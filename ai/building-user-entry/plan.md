Based on my analysis of the codebase, I'll create a comprehensive plan for
  ...
  │   │   ├── Statistics summary ✅
  │   │   └── OKLCH color override for PDF consistency ✅
  │   └── [Export Data] button in residents tab ✅
  ├── Export/Import for Service Charge Bills: ✅ NEW
  │   ├── JSON export for bill data ✅
  │   ├── JSON import with comprehensive validation ✅
  │   ├── Validation for all nested structures (garage, categories) ✅
  │   ├── Import/Export buttons in bill calculator header ✅
  │   └── Mobile-optimized UI (icon-only on small screens) ✅
  ├── Import Building Data: ✅
  │   ├── JSON import (restore complete backup) ✅
  │   ├── File upload validation ✅
  │   ├── Comprehensive data structure validation ✅
  │   └── Already implemented in BuildingSetup component ✅
  ├── Print Functionality: ✅
  │   ├── ResidentsPrint component (preview + PDF) ✅
  │   ├── Statistics dashboard in print view ✅
  │   ├── Floor-grouped resident listing ✅
  │   ├── Color-coded ownership badges ✅
  │   ├── Parking icons display ✅
  │   └── Bilingual print support ✅
  └── Mobile UI Optimization: ✅
      ├── Icon-only buttons on mobile ✅
      ├── Responsive text hiding/showing ✅
